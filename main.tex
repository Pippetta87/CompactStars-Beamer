...
\begin{frame}[fragile]{Stelle Compatte: argomenti del corso}%label={}
    %\framesubtitle{Main onlyparts TOC}
   %\begin{columns}[T]%list of frame a inizio sezione
    % \begin{column}{0.45\textwidth}
    \begin{multicols}{2}
...
\frameinlbffalse
\begin{frame}{Stelle Compatte: i frames pi\'u importanti}%label={}
     \listofcherryframes
%\ifframeinlbf
%    true
%\else
...
\part{Microphysics}\linkdest{microphysics}
\input{microphysics}

\part{Dense stars}\linkdest{densestars}
\input{NS}
